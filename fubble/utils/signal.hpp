#ifndef UUID_93938344_4A15_4F3D_95B8_A6EA984D6365
#define UUID_93938344_4A15_4F3D_95B8_A6EA984D6365
...
constexpr bool is_observer_v =
    std::is_base_of<::utils::signal::detail::observer_type,
...
union SIGSLOT_MAY_ALIAS func_ptr {
  ...
  template <typename T> T &value() { return *static_cast<T *>(value()); }
...
private:
  template <typename, typename...> friend class ::utils::signal::signal_base;
...
public:
   ...
   */
  template <typename... U> void operator()(U &&...a) {
    if (m_block) {
      return;
    }
  ...
  std::enable_if_t<(trait::is_callable_v<arg_list, Callable> ||
                    ...
                    trait::is_pmf_v<Callable>)&&detail::
                       function_traits<Callable>::is_disconnectable,
                   size_t>
 ...
 */
template <typename... T> using signal = signal_base<std::mutex, T...>;
