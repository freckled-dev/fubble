...
public:
  ...
  sigslot::signal<video_ptr> on_video_added;
  sigslot::signal<video_ptr> on_video_removed;
  ...
  sigslot::signal<rtc::audio_track &> on_audio_added;
  sigslot::signal<rtc::audio_track &> on_audio_removed;

  virtual videos_type get_screens() const { return {}; }
  sigslot::signal<video_ptr> on_screen_added;
  sigslot::signal<video_ptr> on_screen_removed;
...
protected:
  ...
  const std::string id;
  sigslot::scoped_connection connection_update;
};
} // namespace client
