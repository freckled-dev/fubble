...
public:
  ...
  std::shared_ptr<rtc::audio_track> get_track() override { return {}; }
};
class add_audio_to_connection_impl final : public add_audio_to_connection {
public:
  add_audio_to_connection_impl(std::shared_ptr<rtc::audio_track> source)
      : audio_track(source) {}
...
add_audio_to_connection::create(std::shared_ptr<rtc::audio_track> source) {
