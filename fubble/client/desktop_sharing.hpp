...
public:
  ...
  utils::signal::signal<preview> on_screen_added;
  utils::signal::signal<preview> on_screen_removed;
  virtual previews get_windows() = 0;
  utils::signal::signal<preview> on_window_added;
  utils::signal::signal<preview> on_window_removed;
...
public:
  ...
  utils::signal::signal<video_ptr> on_added;
  utils::signal::signal<video_ptr> on_removed;
